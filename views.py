# Импортируе Blueprint, render_template, request, redirect, url_for, flash, abort
from flask import Blueprint, render_template, request, redirect, url_for, flash, abort
# Импортируе login_user, logout_user, login_required, current_user
from flask_login import login_user, logout_user, login_required, current_user
# Импортируе secure_filename
from werkzeug.utils import secure_filename
# Импортируе db, bcrypt
from . import db, bcrypt
# Импортируе модели User, Shop, Product, Comment
from .models import User, Shop, Product, Comment
# Импортируе формы LoginForm, RegisterForm, ShopForm, ProductForm, CommentForm, SearchForm, ChangePasswordForm, EditProfileForm
from .forms import (LoginForm, RegisterForm, ShopForm, ProductForm, CommentForm, SearchForm, ChangePasswordForm, EditProfileForm)
# Импортируе os
import os
