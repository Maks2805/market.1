# Импортируем формы Flask
from flask_wtf import FlaskForm
# Импортируем StringField, PasswordField, TextAreaField, FloatField, SubmitField, BooleanField, FileField
from wtforms import (StringField, PasswordField, TextAreaField, FloatField, SubmitField, BooleanField, FileField)
# Импортируем DataRequired, Email, Length, ValidationError, EqualTo, NumberRange
from wtforms.validators import (DataRequired, Email, Length, ValidationError, EqualTo, NumberRange)
# Импортируем FileAllowed
from flask_wtf.file import FileAllowed
# Импортируем модели User и Shop
from .models import User, Shop

# Создаем Класс BaseForm от FlaskForm
...
# Создаем Класс LoginForm от FlaskForm
...
# Создаем Класс RegisterForm от BaseForm
...
# Создаем Класс ShopForm от BaseForm
...
# Создаем Класс ProductForm от FlaskForm
...
# Создаем Класс CommentForm от FlaskForm
...
# Создаем Класс EditProfileForm от BaseForm
...
# Создаем Класс ChangePasswordForm от FlaskForm
...
# Создаем Класс SearchForm от FlaskForm
